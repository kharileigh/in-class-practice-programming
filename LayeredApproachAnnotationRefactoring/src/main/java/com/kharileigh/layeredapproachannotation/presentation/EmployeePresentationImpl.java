...
package com.kharileigh.layeredapproachannotation.presentation;
...
import com.kharileigh.layeredapproachannotation.service.EmployeeService;
		...
		case 6:
			...
			break;
                case 7 :
                        ...
                        // GET GIVEN DEPARTMENT AS INPUT FROM USER
                        String employeeDepartment = scanner.next();
                        
                        // CREATE LIST FOR EMPLOYEES BY DEPARTMENT - CALLS SERVICE LAYER METHOD TO CARRY OUT PROCESS
                        List<Employee> employeeByDepartment = employeeService.getEmployeeByDepartment(employeeDepartment);
                        
                        // IF ITS NOT AN EMPTY LIST - DISPLAY TO USER
