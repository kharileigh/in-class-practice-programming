...
import com.kharileigh.layeredapproachannotation.persistence.EmployeeDao;
import com.kharileigh.layeredapproachannotation.persistence.EmployeeDaoImpl;
...
//----- LABEL CLASS AS COMPONENT & AUTOWIRED FOR THE CHOSEN CLASS TO BE USED FOR IMPLEMENTATION
@Component("service")
public class EmployeeServiceImpl implements EmployeeService {
	...
	private EmployeeDao employeeDao;
        ...
        public EmployeeServiceImpl(@Autowired EmployeeDao employee) {
            super();
