...
package com.kharileigh.studentxmlannotationconfig.client;

import com.kharileigh.studentxmlannotationconfig.presentation.StudentPresentation;
...
public class StudentClient {
    ...
    public static void main(String[] args) {
       ...
       ApplicationContext springContainer = new ClassPathXmlApplicationContext("studentxmlannotationconfig.xml");
